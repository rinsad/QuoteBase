...
import { sendCustomerQuoteEmail } from "@/app/(dashboard)/quotes/[id]/actions";
  ...
  return (
    <main className="app-background">
      <div className="mx-auto grid w-full max-w-7xl gap-6 lg:grid-cols-[360px_1fr]">
        <aside className="glass-panel p-5 sm:p-6 lg:sticky lg:top-6 lg:self-start">
          ...
          <h1 className="mt-1 text-2xl font-semibold">Preview quote PDF</h1>
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            Review the customer-facing quote template before sending the PDF
            attachment and acceptance link.
          </p>
        ...
        <section className="glass-panel overflow-hidden p-3 sm:p-4">
          <div className="max-h-[78vh] overflow-auto rounded-[18px] border border-border bg-slate-100 p-5 shadow-sm">
            <QuotePreviewDocument quote={quote} companyName={companyName} />
          </div>
        </section>
      </div>
    </main>
...
function QuotePreviewDocument({
  ...
  return (
    <article className="mx-auto max-w-5xl bg-white p-8 shadow-[0_20px_70px_rgba(15,23,42,0.12)]">
